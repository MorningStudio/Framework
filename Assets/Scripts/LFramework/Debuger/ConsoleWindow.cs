...
namespace LFramework
{
    ...
    internal sealed class ConsoleWindow : IDebuggerWindow
    {
        ...
        public void Initialize(params object[] args)
        {
            ...
            m_LockScroll = m_LastLockScroll = SettingManager.Instance.GetBool("Debugger.Console.LockScroll", true);
            m_InfoFilter = m_LastInfoFilter = SettingManager.Instance.GetBool("Debugger.Console.InfoFilter", true);
            m_WarningFilter = m_LastWarningFilter = SettingManager.Instance.GetBool("Debugger.Console.WarningFilter", true);
            m_ErrorFilter = m_LastErrorFilter = SettingManager.Instance.GetBool("Debugger.Console.ErrorFilter", true);
            m_FatalFilter = m_LastFatalFilter = SettingManager.Instance.GetBool("Debugger.Console.FatalFilter", true);
        }
        ...
        public void OnUpdate(float elapseSeconds, float realElapseSeconds)
        {
            if (m_LastLockScroll != m_LockScroll)
            {
                ...
                SettingManager.Instance.SetBool("Debugger.Console.LockScroll", m_LockScroll);
            }

            if (m_LastInfoFilter != m_InfoFilter)
            {
                m_LastInfoFilter = m_InfoFilter;
                SettingManager.Instance.SetBool("Debugger.Console.InfoFilter", m_InfoFilter);
            }

            if (m_LastWarningFilter != m_WarningFilter)
            {
                m_LastWarningFilter = m_WarningFilter;
                SettingManager.Instance.SetBool("Debugger.Console.WarningFilter", m_WarningFilter);
            }

            if (m_LastErrorFilter != m_ErrorFilter)
            {
                m_LastErrorFilter = m_ErrorFilter;
                SettingManager.Instance.SetBool("Debugger.Console.ErrorFilter", m_ErrorFilter);
            }

            if (m_LastFatalFilter != m_FatalFilter)
            {
                m_LastFatalFilter = m_FatalFilter;
                SettingManager.Instance.SetBool("Debugger.Console.FatalFilter", m_FatalFilter);
            }
        }
