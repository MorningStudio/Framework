    ...
    public sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
    {
        ...
        public override int Capacity
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new LException("Capacity is invalid.");
                }
        ...
        public override float ExpireTime
        {
            ...
            set
            {
                if (value < 0f)
                {
                    throw new LException("ExpireTime is invalid.");
                }
        ...
        public void Register(T obj, bool spawned)
        {
            if (obj == null)
            {
                throw new LException("Object is invalid.");
            }
        ...
        public void Unspawn(object target)
        {
            if (target == null)
            {
                throw new LException("Target is invalid.");
            }
            ...
            throw new LException(string.Format("Can not find target in object pool '{0}'.", Utility.Text.GetFullName<T>(Name)));
        }
        ...
        public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
        {
            ...
            {
                throw new LException("Release object filter callback is invalid.");
            }
            ...
            foreach (ObjectBase toReleaseObject in toReleaseObjects)
            {
                ...
                {
                    throw new LException("Can not release null object.");
                }
                ...
                if (!found)
                {
                    throw new LException("Can not release object which is not found.");
                }
            }
        }
